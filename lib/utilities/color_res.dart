...
class ColorRes {
  ...
  static const Color themeGradient1 = Color(0xFFE8CC6A);
  static const Color themeGradient2 = Color(0xFFD4AF37);
  static const Color themeAccentSolid = Color(0xFFD4AF37);
